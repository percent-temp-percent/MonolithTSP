...
ent-TechDiskShields = технодиск щитов для шаттла
  .desc = Диск предтечей, добавляющий полную линейку MS-щитов в рецепты сервера. Гражданские тяжёлые FSG (tier 3–4) — отдельные диски Forge; FSG T1–T2 и фракционные массивы — через исследования.
ent-TechDiskForgeFSGCivilianT3 = технодиск Forge FSG (гражданский tier 3)
  .desc = Добавляет платы FSG-420, FSG-470P и FSG-600C в рецепты принтера. Встречается чаще, чем диск с FSG-900P.
ent-TechDiskForgeFSG900P = технодиск Forge FSG-900P (tier 4)
